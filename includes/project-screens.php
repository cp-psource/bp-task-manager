 ...
 * @package PSourceProjektManager\PSourceProjektManagerProjectScreens
 */
final class PSourceProjektManagerProjectScreens {
	...
	public static function bp_projects_main_screen_function() {
		...
		add_action( 'bp_template_title', array( 'PSourceProjektManagerProjectScreens', 'bp_projects_title' ) );

		add_action( 'bp_template_content', array( 'PSourceProjektManagerProjectScreens', 'bp_projects_content' ) );
	...
	public static function bp_projects_main_screen_function_new_project() {
		...
		add_action( 'bp_template_title', array( 'PSourceProjektManagerProjectScreens', 'bp_projects_add_new_title' ) );

		add_action( 'bp_template_content', array( 'PSourceProjektManagerProjectScreens', 'bp_projects_add_new_content' ) );
	...
	public function bp_projects_menu_header() {
		...
		esc_html_e( 'Menükopfzeile', 'bp-projekt-manager' );
	...
	public static function bp_projects_title() {
		...
		esc_html_e( 'Öffentliche Gruppenprojekte', 'bp-projekt-manager' );
	...
	public static function bp_projects_add_new_title() {
		...
		esc_html_e( 'Neues Projekt', 'bp-projekt-manager' );
...
$taskbreaker_project_screens = new PSourceProjektManagerProjectScreens();

// Include and start the theme compatibility.
require_once TASKBREAKER_DIRECTORY_PATH . 'includes/project-theme-compat.php';

$taskbreaker_theme_compat = new PSourceProjektManagerThemeCompatibility();
