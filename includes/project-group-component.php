 ...
 * @package PSourceProjektManager\PSourceProjektManagerProjectsGroupExtension
 */
 ...
 *
 * @package PSourceProjektManager\PSourceProjektManagerProjectGroupExtension
 */
class PSourceProjektManagerProjectsGroupExtension extends BP_Group_Extension {
	...
	function display( $group_id = null ) {
		...
		<h3><?php esc_html_e( 'Projekte', 'bp-projekt-manager' ); ?></h3>
...
bp_register_group_extension( 'PSourceProjektManagerProjectsGroupExtension' );
