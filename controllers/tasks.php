...
/**
 * Manually include the PSourceProjektManagerTasksController dependency.
 */
require_once plugin_dir_path( __FILE__ ) . '../models/tasks.php';

/**
 * PSourceProjektManagerTasksController class is a Singleton object
 * that handles the request coming from Transactions Controller
 * and delegates the task to the right methods. This class uses
 * PSourceProjektManagerTask methods to add, edit, delete, and display tasks
 *
 * @since    1.0 Early Plugin Release
 * @author   Joseph G. [joseph@useissuestabinstead.com]
 * @version  1.0
 */
class PSourceProjektManagerTasksController extends PSourceProjektManagerTask {
	...
	public static function get_instance() {
		...
		if ( null === $instance ) {
			...
			$instance = new PSourceProjektManagerTasksController();
