 ...
 *
 * @since 0.0.1
 * @package PSourceProjektManager\PSourceProjektManagerCT
 */
...
/**
 * PSourceProjektManagerCT is a singleton class that contains several useful methods to check the capability
 * of the current logged in user before creating task, deleting task, creating new project, etc.
 *
 * @package PSourceProjektManager\PSourceProjektManagerCT
 */
class PSourceProjektManagerCT {
	 ...
	 *
	 * @return object PSourceProjektManagerCT
	 */
	...
	/**
	 * Singleton method that instantiate or return the current instance of PSourceProjektManagerCT.
	 *
	 * @return object PSourceProjektManagerCT
	 */
	public static function get_instance() {
		...
		if ( null === $instance ) {
			$instance = new PSourceProjektManagerCT();
		}
		return $instance;
	}
