 ...
 */
class PSourceProjektManagerTaskComment {
	...
	public function __construct() {
		$this->dbase = PSourceProjektManager::wpdb();

		$this->dbase_prefix = PSourceProjektManager::bp_core_get_table_prefix();
		...
		if ( $insert_comments ) {
			...
			if ( function_exists( 'bp_activity_add' ) ) {
				...
				if ( function_exists( 'bp_core_get_userlink' ) ) {
				 ...
				 $status_label = array(
				  	__( 'hat ein neues Update in gepostet in', 'bp-projekt-manager' ),
				   	__( 'abgeschlossen', 'bp-projekt-manager' ),
				   	__( 'wieder geöffnet', 'bp-projekt-manager' ),
				  );

				 $status_content_label = array( __( 'Aktualisiert', 'bp-projekt-manager' ), __( 'Abgeschlossen', 'bp-projekt-manager' ), __( 'Wiedereröffnet', 'bp-projekt-manager' ) );
				 ...
				 if ( function_exists( 'groups_record_activity' ) ) {
						  ...
						  $action_i18 = __( '%1$s %2$s die Aufgabe %3$s %4$s', 'bp-projekt-manager' );
